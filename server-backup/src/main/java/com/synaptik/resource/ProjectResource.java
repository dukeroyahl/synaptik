...
import com.synaptik.dto.ProjectUpdateRequest;
...
public class ProjectResource {
    ...
    public Uni<Response> createProject(@Valid ProjectCreateRequest request) {
    ...
    public Uni<Response> updateProject(@PathParam("id") String id, @Valid ProjectUpdateRequest request) {
        Project updates = request.toProject();
