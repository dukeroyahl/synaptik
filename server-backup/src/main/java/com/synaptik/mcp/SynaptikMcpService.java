package com.synaptik.mcp;

import com.synaptik.dto.ProjectCreateRequest;
...
import com.synaptik.service.MindmapService;
import com.synaptik.service.ProjectService;
...
public class SynaptikMcpService {
    ...
    public Uni<String> createTask(
            ...
            @ToolArg(description = "Scheduled date (ISO format)") String scheduledDate,
