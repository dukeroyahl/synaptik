...
import com.synaptik.dto.MindmapCreateRequest;
...
public class MindmapResource {
    ...
    public Uni<Response> createMindmap(@Valid MindmapCreateRequest request) {
        Mindmap mindmap = request.toMindmap();
    ...
    public Uni<Response> updateMindmap(@PathParam("id") String id, @Valid MindmapCreateRequest request) {
        Mindmap updates = request.toMindmap();
