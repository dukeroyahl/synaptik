...
echo "   API Docs: http://localhost:8060/q/swagger-ui"
echo ""
...
echo ""
echo "📡 MCP Connection Troubleshooting:"
echo "   If MCP server can't connect to Synaptik API, try:"
echo ""
echo "   Option A: Set API URL environment variable"
echo "   export SYNAPTIK_API_URL=http://localhost:8060"
echo "   ./synaptik-mcp"
echo ""
echo "   Option B: Check if API is accessible"
echo "   curl http://localhost:8060/q/health"
echo ""
echo "   Option C: Restart Docker services"
echo "   cd $(pwd) && docker compose restart"
echo ""
